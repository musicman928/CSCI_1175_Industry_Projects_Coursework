...
public class TabPaneDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        borderPane.setPrefWidth(tabPane.getPrefWidth());

        GridPane gridPane = new GridPane();
        gridPane.addRow(0, borderPane);
        ...
        radioButtonPane.addColumn(0, btTop);
        radioButtonPane.addColumn(1, btLeft);
        radioButtonPane.addColumn(2, btBottom);
        radioButtonPane.addColumn(3, btRight);

        gridPane.addRow(1, radioButtonPane);



        Scene scene = new Scene(gridPane, 228, 250);
